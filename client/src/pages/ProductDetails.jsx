        ...
        <div className='md:min-w-[49%] md:h-auto px-5 py-5'>
          ...
          <div> {/*Choose size div*/}
            ...
            <div className='md:h-10 m-2 md:grid md:grid-cols-[20%_20%_20%_20%] md:gap-5 gap-2 flex '>
                <div className='border rounded-3xl flex items-center justify-center bg-gray-300 px-2'> Small</div>
                <div className='border rounded-3xl flex items-center justify-center bg-gray-300 px-2'> Medium </div>
                <div className='border rounded-3xl flex items-center justify-center bg-gray-300 px-2'> Large </div>
                <div className='border rounded-3xl flex items-center justify-center bg-gray-300 px-2'> X-Large </div>
            </div>
            </div> 
          <div className='border my-5 border-gray-400'></div> {/*line*/}
          <div className='grid grid-cols-[20%_70%] gap-5 h-10'>
            <div className='border flex w-full rounded-3xl items-center justify-between px-2'>
              <div>+</div>
              <div>0</div>
              <div>-</div>
            </div>
