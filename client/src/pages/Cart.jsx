...
const Cart = () => {
  ...
  return (
    ...
    <div className='px-12 py-5'> 
      ...
      <div className=' grid grid-cols-[60%_39%] gap-4'>
          ...
          <div className='border rounded-xl border-gray-300 px-2 py-2'>
            ...
            <div className='mt-3 flex flex-col gap-y-3'>
              ...
              <div className='grid grid-cols-[70%_27%] gap-4'>
                <div className=' '>
                  <input className='py-1 w-full bg-gray-100 border rounded-2xl px-2' placeholder='Apply Coupon'></input>
                </div>
                <div className=''>
                  <button className='px-7 h-full w-full text-white bg-black rounded-2xl border'>Apply</button>
                </div>
              </div>

              <div>
                <button className='px-7 py-2 h-full w-full text-white bg-black rounded-3xl border'>Go to CheckOut</button>
              </div>
            </div>
          </div>
        </div>
